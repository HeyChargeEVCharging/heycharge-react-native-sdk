...
var _exportNames = {
  initialize: true,
  setUserId: true,
  initializeChargers: true,
  getUserPropertiesCombined: true,
...
exports.getUserPropertiesCombined = getUserPropertiesCombined;
exports.initialize = initialize;
exports.initializeChargers = initializeChargers;
...
function initializeChargers(propertyId) {
...
function getUserPropertiesCombined() {
  return new Promise((resolve, reject) => {
    console.log('NEW >> before calling getUserPropertiesCombined from native');
    HeychargeSdk.getUserPropertiesCombined(jsonString => {
      try {
